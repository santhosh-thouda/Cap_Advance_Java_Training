...
public class DemoController {
    ...
    //@GetMapping("/a")
    // @ResponseBody // it returns the data which is there in a function body,
    // but it will work even if it is not there but then it should return any file(webpage) not data
//    public String hello() {
//        return "hello.html";
//    }
...
//    @PostMapping("/b")
    ...
    public List<String> hello(){
        return List.of("Rohit", "Kohli", "Hardik", "Dhoni", "Abhishek", "Ishan Kishan");
    }
